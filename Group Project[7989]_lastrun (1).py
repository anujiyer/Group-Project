...
expName = 'Group Project'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Neha N Shah\\Desktop\\Group Project[7989]_lastrun.py',
...
win = visual.Window(
    ...
    monitor='testMonitor', color=[0.3569, 1.0000, -0.6314], colorSpace='rgb',
...
target = visual.TextStim(win=win, name='target',
    ...
    color=[1.0000, -0.1765, 0.4118], colorSpace='dkl', opacity=None, 
    languageStyle='LTR',
    depth=-1.0);
...
for thisTrial in trials:
    ...
    for i in range(num_distr):
        ...
        distr = visual.TextStim(win=win, name='distr',
            ...
            color=[0,1,3], colorSpace='dkl', opacity=None, 
            languageStyle='LTR',
            depth=0.0);
    ...
    for i in range(num_distr):
        ...
        distr = visual.TextStim(win=win, name='distr',
            ...
            font='Open Sans',
            pos=(random()-0.5, random()-0.5), height=0.1, wrapWidth=None, ori=randint(0,360), 
            color=[0,1,1], colorSpace='dkl', opacity=None, 
            languageStyle='LTR',
            depth=0.0);
    ...
    for i in range(num_distr):
        ...
        distr = visual.TextStim(win=win, name='distr',
            ...
            font='Open Sans',
            pos=(random()-0.5, random()-0.5), height=0.1, wrapWidth=None, ori=randint(0,360), 
            color=[0,1,2], colorSpace='dkl', opacity=None, 
            languageStyle='LTR',
            depth=0.0);
    ...
    trialComponents = [polygon, target, mouse, target_2]
